...
var generateSeed = function () { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                _a.sent();
                seed = (0, util_crypto_1.mnemonicGenerate)();
                return [4 /*yield*/, (0, exports.getKeyringFromSeed)(seed)];
            case 2:
                account = _a.sent();
                return [2 /*return*/, { seed: seed, address: account.address }];
        }
    });
}); };
 ...
 */
var getKeyringFromSeed = function (seed) { return __awaiter(void 0, void 0, void 0, function () {
    var keyring;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, (0, util_crypto_1.cryptoWaitReady)()];
            case 1:
                ...
                return [2 /*return*/, keyring.createFromUri(seed)];
        }
    });
}); };
